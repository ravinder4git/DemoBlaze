...
for(def rowNum=1; rowNum <=findTestData("DemoBlaze Test Data/TC_001_login_Test").getRowNumbers(); rowNum++)
	 { 

//WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Username_loginusername'), username)

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Username_loginusername'), findTestData("DemoBlaze Test Data/TC_001_login_Test").getValue(1,rowNum))

WebUI.setEncryptedText(findTestObject('Object Repository/Page_STORE/input_Password_loginpassword'), findTestData("DemoBlaze Test Data/TC_001_login_Test").getValue(2,rowNum))

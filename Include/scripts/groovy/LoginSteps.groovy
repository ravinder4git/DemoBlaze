...
class LoginSteps {
	...
	def userNavigateToDemoBlazeHomepage() {
		println ("\n User inside the Demo Blaze homepage")
		WebUI.openBrowser('')
	...
	def clickLogin() {
	    println("\n User inside ClickLogin")
		WebUI.click(findTestObject('Object Repository/Page_STORE/button_Log in'))
	}
	
/*	@Then("User is navigated to homepage")
	def verifyHomepage() {
		println("\n User inside Homepage")
		
	} */
	
	@And("User click on desired mobile")
	def clickDesiredMobile() {
		println("\n User inside desired mobile")
		WebUI.click(findTestObject('Object Repository/Page_STORE/a_Samsung galaxy s6'))
	}
	
	@And("User click on home on top")
	def clickHomepage() {
		println("user inside the Homepage")
